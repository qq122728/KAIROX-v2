...
export function sendEmailCode(to: string, code: string, purpose: "register" | "login" | "reset_password"): void {
  ...
  const subject =
    purpose === "register" ? "Your VORX Registration Code" :
    purpose === "reset_password" ? "Your VORX Password Reset Code" :
    "Your VORX Login Code";
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
      <h2 style="color:#1a1a2e;margin:0 0 8px">VORX</h2>
      <p style="color:#666;font-size:14px;margin:0 0 24px">
        ${
          purpose === "register" ? "Use the code below to complete your registration." :
          purpose === "reset_password" ? "Use the code below to reset your password. If you didn't request this, please ignore this email." :
