...
const adminOrigin = normalizeOrigin(process.env.ADMIN_APP_URL || process.env.NEXT_PUBLIC_ADMIN_URL || "https://kairox-abcoooixadmin.kairoxmarkets.xyz");
const allowedOrigins = [...new Set([nextOrigin, adminOrigin, "http://localhost:3000", "http://127.0.0.1:3000"])];
